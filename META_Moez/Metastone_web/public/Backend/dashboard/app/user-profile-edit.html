...
<html lang="en">
  ...
  <body class=" ">
        ...
        <div class="sidebar-body p-0 data-scrollbar">
            <div class="collapse navbar-collapse" id="sidebar">
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target="_blank" href="https://templates.iqonic.design/lite/nairobi/documentation/html/dist/main/">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> Nairobi, Made with
    ...
    <script src="../../assets/js/countdown.js" ></script>  </body>
</html>
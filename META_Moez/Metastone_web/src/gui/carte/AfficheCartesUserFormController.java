...
public class AfficheCartesUserFormController implements Initializable {
    ...
    @FXML
    private void to_merche(ActionEvent event) throws IOException {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../merche/user/AfficheMercheUserForm.fxml"));
             fxml=loader.load(); 

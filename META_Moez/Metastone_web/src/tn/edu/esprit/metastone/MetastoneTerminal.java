...
import tn.edu.esprit.service.IcommentaireService;
import tn.edu.esprit.service.IposteService;
 ...
 * @author admin
 */
public class MetastoneTerminal {
...
//
//Iservices iu=new ServiceUtilisateur();
        //System.out.println(iu.afficher());
        
        IcommentaireService ip=new CommentaireService();
        
        System.out.println(ip.afficherCommentaire());

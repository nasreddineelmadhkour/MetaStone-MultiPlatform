...
*/
    /*
    public Merche(String Nom_produit, int Prix_produit, String Description_produit, String Type_produit, int Taille_produit, int Quantite_produit, String Image_produit) {

...
//ctor
    ...
    //ctor with ID
    public Merche(int Id_produit, String Nom_produit, float Prix_produit, String Description_produit, String Type_produit, int Taille_produit)
    {
    ...
    //ctor w/o ID
    public Merche(String Nom_produit, float Prix_produit, String Description_produit, String Type_produit, int Taille_produit)
    {
        this.Nom_produit = Nom_produit;
        this.Prix_produit = Prix_produit;
        this.Description_produit = Description_produit;
...
//Affichage
    ...
    public String toString() {
        return "Merche{" + "Id_produit=" + Id_produit + ", Nom_produit=" + Nom_produit + ", Prix_produit=" + Prix_produit + ", Description_produit=" + Description_produit + ", Type_produit=" + Type_produit + ", Taille_produit=" + Taille_produit + '}';
    }

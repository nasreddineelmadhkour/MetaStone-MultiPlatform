 ...
 * Utilisateur
 *
 * @ORM\Table(name="utilisateur", uniqueConstraints={@ORM\UniqueConstraint(name="E_mail", columns={"email"}), @ORM\UniqueConstraint(name="Nom_utilisateur", columns={"Nom_utilisateur"})})
 * @ORM\Entity
 */
class Utilisateur
{
